...
describe("Qr Card Component", () => {
  ...
  it("validate if the image contain the url of the photo qr code in the qr card", () => {
    ...
    expect(qrImageCard).toHaveAttribute('src', 'https://github.com/CesarGMEFA/qr-code/raw/main/src/images/image-qr-code.png')
  })
  ...
  it("Validate the title h1 tag in the card contain text", () => {
    ...
    render(<QrCard />)
    const paragraph = "Scan the QR code to visit Frontend Mentor and take your coding skills to the next level"
